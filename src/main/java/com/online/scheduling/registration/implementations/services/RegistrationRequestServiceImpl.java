...
import com.online.scheduling.registration.interfaces.email.IEmailService;
...
public class RegistrationRequestServiceImpl implements IRegistrationRequestService {
    ...
    public RegistrationRequestServiceImpl(
            ...
            ConfirmationTokenService confirmationTokenService, UserAccountService userAccountService) {
